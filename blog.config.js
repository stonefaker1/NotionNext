...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Yoojay', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || '',
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://yoojay.net', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Yoojay，有界', // 网站关键词 英文逗号隔开
  ...
  AVATAR: '/Yoojay-notion.webp', // 头像/Logo 设置
  BLOG_FAVICON: '/Yoojay-notion.webp', // 如果你也想让浏览器标签页图标(Favicon)变成这个，改下面这行：
